...
async function main() {
    ...
    const STABIL = "0x383518188c0c6d7730d91b2c03a03c837814a899";
    ...
    const CVXBond = await ethers.getContractFactory('StabiliteCVXBondDepository');

    // Deploy CVX bond
    const cvxBond = await CVXBond.deploy(STABIL, CVX, Treasury, DAO);
