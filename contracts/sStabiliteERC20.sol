...
contract sStabilite is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("Staked Stabilite", "sSTABIL", 9) ERC20Permit() {
  ...
  /**
        @notice increases sSTABIL supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sSTABIL
